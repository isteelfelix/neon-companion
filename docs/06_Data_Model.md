...
- **AvatarMotionPack** — описание 2D sprite-sheet набора для одного аватара (`manifest.json`, clips, defaultAction)
- **AvatarMotionClip** — один action-клип (`action`, `file`, `columns`, `rows`, `frameCount`, `fps`, `loop`)
