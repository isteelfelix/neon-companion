...
Чтобы сохранить полную амплитуду без клипинга, грудные области четырёх слоёв
одежды используют не меньший суммарный Bust-вес, чем ближайшая поверхность тела.
Инструмент настройки переносит веса детерминированно и не ставит angle limit.
