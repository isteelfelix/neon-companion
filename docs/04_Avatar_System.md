...
Полная амплитуда Bust-цепей не ограничивается искусственным cone limit. Чтобы
внутренний меш не пробивал одежду на пике инерции, у встроенной Neon VRM скрыты
только 800 треугольников тела, полностью закрытых непрозрачной частью серого
топа. Открытая зона декольте и исходные веса всех слоёв одежды сохранены.
