...
| A-11 | Система триггерных анимаций | 📋 | M2 | Персонаж всегда в idle. Триггер запускает анимацию в ping-pong, затем возврат в idle. Game-like state machine |
...
| U-08 | Кнопка выхода в настройках | 🔧 | M2 | Добавить внизу настроек (рядом с GitHub/Документация) |
...
| U-11 | Баг: сжатие левой панели | 🔧 | M2 | Иконки уезжают за границу экрана при ресайзе рельса |
| U-12 | Баг: многострочный ввод — переполнение | 🔧 | M2 | Текст вылезает за визуальные границы поля ввода |
