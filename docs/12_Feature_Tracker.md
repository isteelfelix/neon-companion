...
| A-13 | VRM runtime Phase B | ⏳ | M4 | UniVRM 0.131.2 import/render, actual humanoid/blink/gaze/expression/lipsync capability extraction, restricted fallback, VRMA states, immediate voice-stop clearing, and mouse-drag-driven authored VRMC_springBone motion implemented. Felix fixture committed; needs Felix Unity/Windows gallery→preview, spring-bone and TTS/lipsync smoke verification. |
