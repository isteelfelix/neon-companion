    ...
    32|| H-04 | Папки для сессий (как проекты) | 🔧 | M2 | Группировка сессий по папкам |
    33|
    34|## Аватары
    ...
    45|| A-09 | Загрузка спрайтшитов — производительность | 🔧 | M2 | Lazy loading сломал preload during splash — вернуть eager preload + плавная загрузка |
    ...
    61|| U-10 | Иконка приложения в интерфейсе | 🔧 | M2 | Вверху слева, рядом с названием |
    62|| U-11 | Баг: сжатие левой панели | ✅ | M2 | overflow: hidden на .rail |
    63|| U-12 | Баг: многострочный ввод — переполнение | 🔧 | M2 | Shift+Enter не переносит строку, Enter всегда отправляет. ChatController.cs:428 — не проверяется shiftKey |
    ...
    73|| U-22 | Enter-to-send | 🔧 | M2 | Toggle в настройках. Сломан — same as U-12: Shift+Enter не работает |
    ...
    92|| U-40 | Звуки уведомлений | 🔧 | M2 | Звук когда ответ готов, если окно не в фокусе |
    93|| U-41 | Отображение картинок в чате | 🔧 | M2 | Рендер вложений-изображений инлайн в bubble вместо текста [image] (Image + async UnityWebRequestTexture, IsImageFile). |
    94|| U-42 | Вставка изображений из буфера обмена | 🔧 | M2 | Ctrl+V / Cmd+V — вставить скопированное изображение как вложение в композер |
    ...
    96|| U-44 | Drag-and-drop файлов в чат | 🔧 | M2 | Перетащить PDF/код/картинку → агент анализирует |
