...
| # | Фича | Статус | Спринт | Заметки |
|---|------|--------|--------|---------|
| PL-01 | Полная поддержка Android как целевой платформы | ✅ | M3 | Verified by Felix (июнь 2026) |
|| PL-02 | Доработка IFilePickerService под Android (нативный Java плагин NeonFilePickerActivity) | ✅ | M3 | Verified by Felix (июнь 2026) |\n|| PL-03 | Android permissions и AndroidManifest.xml | ✅ | M3 | Verified by Felix (июнь 2026) |\n|| PL-04 | Адаптация UI под мобильные экраны (тач, клавиатура, safe area, разные DPI) | ✅ | M3 | Verified by Felix (июнь 2026) |\n| PL-05 | Голос на Android (TTS + SpeechRecognizer вместо DictationRecognizer) | ✅ | M3 | Verified by Felix (июнь 2026) |
