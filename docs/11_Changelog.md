...
### Fixed
- Neon bust springs now receive a bust-only procedural idle force plus stronger turn inertia in both the main preview and detached Companion process; softer spring coefficients no longer leave a stationary model visually rigid.
