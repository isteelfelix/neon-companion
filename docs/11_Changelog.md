...
### Fixed
- Neon bust springs now receive a bust-only procedural idle force plus full turn inertia in both the main preview and detached Companion process. All 356 chest-clothing vertices, including previously rigid lower outer sections and the bra's lower edge, follow the nearest weighted body surface without suppressing spring amplitude.
