...
### Fixed
- Neon bust springs now receive a bust-only procedural idle force plus full turn inertia in both the main preview and detached Companion process. Chest clothing weights follow the nearest weighted body surface, preventing skin-through-cloth clipping without suppressing spring amplitude.
