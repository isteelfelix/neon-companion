...
namespace NeonCompanion.Runtime.Api.Hermes
{
    ...
    public class HermesRemoteAuth
    {
        ...
        ///
        /// The ticket is NOT profile-scoped: Desktop mintGatewayWsTicket posts to the plain
        /// endpoint with no profile in the query or the body, and the resulting socket serves
        /// every profile. Which profile a chat belongs to is decided per RPC, by the profile
        /// param on session.create / session.resume.
        /// </summary>
